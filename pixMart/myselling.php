...
if (isset($_SESSION["user"])) {
    ...
    `title`,`invoice`.`date`,`invoice`.`id` AS `inid`,`product_id`,`invoice`.`qty` AS `invqty`,`price`,`delivery_fee_colombo`,`delivery_fee_other`,`description`,`invoice`.`user_email` AS `uemail` ,`total`  FROM `invoice` INNER JOIN `product` ON `product`.`id`=`invoice`.`product_id`  WHERE `product`.`user_email` ='" . $_SESSION["user"]["email"] . "';");
                    ...
                    <div class="row">
                        ...
                        ?>
                            <div class="col-11 col-lg-9" id="show">
                                ...
                                INNER JOIN `invoice` ON `invoice`.`product_id`=`product`.`id`
                                ...
                                INNER JOIN `user` ON `user`.`email`=`invoice`.`user_email` WHERE `product`.`id`='" . $pro["product_id"] . "'  ;");
                                        ...
                                        <div class="card mb-3  col-12">
                                            <div class=" row g-0">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    </div> &nbsp; <span class="fw-bold text-black">Rs.<?php echo $shipping; ?></span>
                                                </div>
